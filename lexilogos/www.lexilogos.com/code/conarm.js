...
car = car.replace(/պʼ/g, "փ");
car = car.replace(/կʼ/g, "ք");
car = car.replace(/տʼ/g, "թ");
...
car = car.replace(/ց/g, "cʼ");
car = car.replace(/ւ/g, "w");
car = car.replace(/փ/g, "pʼ");
car = car.replace(/ք/g, "kʼ");

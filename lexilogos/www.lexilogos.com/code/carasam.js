...
car = car.replace(/[yY]/g, "য়্"); // un seul y
car = car.replace(/R/g, "ড়্");
car = car.replace(/z/g, "য্"); // z replace y
car = car.replace(/r/g, "ৰ্"); // autre 
car = car.replace(/w/g, "ৱ্"); // ajout 
car = car.replace(/l/g, "ল্");
car = car.replace(/h/g, "হ্");
car = car.replace(/[SXṣṢ]/g, "ষ্");
car = car.replace(/[sx]/g, "স্");
// cas particuliers 
car = car.replace(/K/g, "ক্ষ্"); // ajout k+S 
...
car = car.replace(/[çśŚ]/g, "শ্"); // pas de z

// cas du ri li 
car = car.replace(/্-ৰ/g, "ৃ");
car = car.replace(/-ৰ/g, "ঋ");

...
car = car.replace(/ث'/g, "ٹ");
car = car.replace(/ٹ'/g, "ت");
car = car.replace(/ṯ/g, "ث");
car = car.replace(/ʈ/g, "ٹ");
...
car = car.replace(/ذ'/g, "ڈ");
car = car.replace(/ڈ'/g, "د");
car = car.replace(/ḏ/g, "ذ");
car = car.replace(/ɖ/g, "ڈ");
car = car.replace(/r/g, "ر");
car = car.replace(/ر'/g, "ز");
car = car.replace(/ز'/g, "ژ");
car = car.replace(/ژ'/g, "ر");
...
car = car.replace(/ۏ'/g, "و");
car = car.replace(/y/g, "ي");
car = car.replace(/ي'/g, "ى");
car = car.replace(/ى'/g, "ي");

car = car.replace(/a/g, "َ");
car = car.replace(/ََ/g, "ا");
car = car.replace(/e/g, "ٖ");
car = car.replace(/i/g, "ِ");
car = car.replace(/o/g, "ٗ");
car = car.replace(/u/g, "ُ");
car = car.replace(/A/g, "أَ");
car = car.replace(/E/g, "إٖ");
car = car.replace(/I/g, "إِ");
car = car.replace(/O/g, "أٗ");
car = car.replace(/U/g, "أُ");

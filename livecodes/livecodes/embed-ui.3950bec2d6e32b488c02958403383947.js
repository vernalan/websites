...
var q = (t) =>
  (
    ...
    ((s) => JSON.parse(JSON.stringify(s, (l, a) => (a === void 0 ? null : a))))
  )(t);
var B = (t) => {
  ...
  if (
    ...
    try {
      ...
      return console.warn("Copy to clipboard failed.", l), !1;
    } finally {
...
var J = [
  ...
  v = {
    getModuleUrl: (
      t,
      { isModule: s = !0, defaultCDN: l = "esm.sh", external: a } = {}
    ) => {
      t = t.replace(/#nobundle/g, "");
      let u = (m) =>
          !a || !m.includes("https://esm.sh")
            ? m
            : m.includes("?")
            ? `${m}&external=${a}`
            : `${m}?external=${a}`,
      ...
      return b
        ...
        : s
        ? u("https://esm.sh/" + t)
        : "https://cdn.jsdelivr.net/npm/" + t;
    },
    getUrl: (t, s) =>
      t.startsWith("http") || t.startsWith("data:")
        ? t
        : K(t, !1, s || re()) || t,
    cdnLists: { npm: Z, module: J, gh: Q },
    checkCDNs: async (t, s) => {
      let l = [s, ...v.cdnLists.npm].filter(Boolean);
      for (let a of l)
        try {
          if ((await fetch(v.getUrl(t, a), { method: "HEAD" })).ok) return a;
        } catch {}
      return v.cdnLists.npm[0];
    },
  },
  re = () => {
    ...
    try {
      return (
        new URL(location.href).searchParams.get("appCDN") || v.cdnLists.npm[0]
      );
    } catch {
      return v.cdnLists.npm[0];
    }
  ...
  K = (t, s, l) => {
    let a = s && t.startsWith("unpkg:") ? "?module" : "";
    t.startsWith("gh:")
      ? (t = t.replace("gh", Q[0]))
      : t.includes(":") || (t = (l || (s ? J[0] : Z[0])) + ":" + t);
    for (let u of se) {
      let [b, m] = u;
      if (b.test(t)) return t.replace(b, m) + a;
    }
    return null;
  },
  se = [
...
var ie = {
  ...
  G = {
    ...
    getSDKUrl: (t = "esm") => v.getUrl(`livecodes@0.11.1/${ie[t]}`),
  };
var Se = async ({
  config: t,
  editorLanguages: s,
  ...
  let M = t.title,
    y = t.activeEditor || "markup",
    I = document.createElement("div");
  I.innerHTML = W;
  let E = I.firstChild;
  l.show(E, { isAsync: !0, onClose: () => C?.destroy() });
  let A = E.querySelector("#embed-preview-container"),
    T = E.querySelector("#embed-form"),
    P = E.querySelector("#embed-code"),
    O = E.querySelector("#embed-copy-btn");
  if (!A || !T || !P || !O) return;
  [
    {
      ...
      options: [
        ...
        {
          label: window.deps.translateString("embed.theme.light", "Light"),
          value: "light",
        },
      ],
    },
    {
      ...
      options: [
        ...
        {
          label: window.deps.translateString("embed.loading.click", "On-click"),
          value: "click",
        },
        {
          label: window.deps.translateString("embed.loading.eager", "Eager"),
          value: "eager",
        },
      ],
    },
    {
      ...
      name: "lite",
      options: [{ value: "true", checked: !1 }],
      help: "https://livecodes.io/docs/features/lite",
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        {
          label: window.deps.translateString(
      ...
      help: "https://livecodes.io/docs/features/display-modes",
    },
    {
      ...
      help: "https://livecodes.io/docs/features/default-view",
    },
    {
      ...
      help: "https://livecodes.io/docs/configuration/configuration-object#layout",
    },
    {
    ...
    },
    {
      ...
      help: "https://livecodes.io/docs/features/editor-settings#code-editor",
    },
    {
      ...
      options: [
        ...
        {
          label: window.deps.translateString("embed.tools.open", "Open"),
          value: "open",
        },
        {
          label: window.deps.translateString("embed.tools.full", "Full"),
          value: "full",
        },
        {
          label: window.deps.translateString("embed.tools.none", "None"),
          value: "none",
        },
      ],
      help: "https://livecodes.io/docs/features/tools-pane",
    },
    {
      title: window.deps.translateString(
      ...
      options: [
        ...
        {
          label: window.deps.translateString("embed.activeTool.tests", "Tests"),
          value: "tests",
        },
      ].filter((e) => !(e.value === "tests" && !t.tests?.content)),
      help: "https://livecodes.io/docs/features/tools-pane",
    },
    {
      title: window.deps.translateString("embed.permanentUrl", "Permanent URL"),
      name: "permanentUrl",
      options: [{ value: "true", checked: !0 }],
      help: "https://livecodes.io/docs/features/permanent-url",
    },
    {
      title: window.deps.translateString(
      ...
      options: [
        ...
        {
          label: window.deps.translateString("embed.embedType.npm", "JS (npm)"),
          value: "npm",
        },
        {
          label: window.deps.translateString("embed.embedType.react", "React"),
          value: "react",
        },
        {
          label: window.deps.translateString("embed.embedType.vue", "Vue"),
          value: "vue",
        },
        {
          label: window.deps.translateString(
        ...
        {
          label: window.deps.translateString("embed.embedType.html", "HTML"),
          value: "html",
        },
      ],
    },
    ...
    if (((o.innerHTML = e.title), T.appendChild(o), e.help)) {
      let r = document.createElement("a");
      (r.href = e.help),
        (r.target = "_blank"),
        r.classList.add("help-link"),
      ...
      d.classList.add("icon-info"), r.appendChild(d);
    }
    ...
    i.classList.add("input-container"),
      ...
      e.options.forEach((r) => {
        let d = `embed-${e.name}`,
          p = `${d}-${r.value}`,
          x = !r.label && r.value === "true",
          k = document.createElement("span");
        i.appendChild(k);
        let g = document.createElement("input");
        if (
          ((g.type = x ? "checkbox" : "radio"),
          (g.name = d),
          (g.id = p),
          (g.value = r.value),
          (g.checked = r.checked || !1),
          k.appendChild(g),
          x)
        )
  ...
  let C = await b(P),
    X = "https://livecodes.io",
    H = G.getSDKUrl("umd"),
    j = await m(!0),
    w = new URL(j),
    D = w.origin + w.pathname,
    R = document.createElement("iframe");
  (R.id = "embed-preview-iframe"),
    (A.innerHTML = ""),
    (R.tabIndex = -1),
    A.appendChild(R);
  let Y = () => "livecodes-" + (Math.random() + 1).toString(36).substring(2),
    S = (e) => {
      let o = {
          ...(e.mode !== f.mode ? { mode: e.mode } : {}),
          ...(e.theme !== f.theme ? { theme: e.theme } : {}),
          ...(!e.lite && (e.tools !== "closed" || e.activeTool !== "console")
            ? {
                tools: {
                  enabled: e.tools === "none" ? [] : "all",
                  status: e.tools,
                  active: e.activeTool,
                },
              }
          ...
          ...(e.mode !== "result" && e.activeEditor !== y
            ? { activeEditor: e.activeEditor }
            : {}),
          ...(e.editor ? { editor: e.editor } : {}),
          ...(e.layout !== f.layout ? { layout: e.layout } : {}),
        },
        i = w.searchParams.get("x");
      return {
        ...(D !== "https://livecodes.io/" ? { appUrl: D } : {}),
        ...(Object.keys(o).length > 0 ? { config: o } : {}),
        ...(i ? { import: i } : {}),
        ...(e.lite ? { lite: e.lite } : {}),
        ...(e.loading !== "lazy" ? { loading: e.loading } : {}),
        ...(e.view && e.view !== "split" ? { view: e.view } : {}),
      };
    },
    F = (e) => {
      let o = new URL(j);
      return (
        o.searchParams.set(e.lite ? "lite" : "embed", "true"),
        e.loading &&
          e.loading !== "lazy" &&
          o.searchParams.set("loading", String(e.loading)),
        e.view &&
          e.view !== "split" &&
          o.searchParams.set("view", String(e.view)),
        e.mode !== "result" &&
          e.activeEditor &&
          e.activeEditor !== y &&
          o.searchParams.set("activeEditor", String(e.activeEditor)),
        e.mode &&
          e.mode !== f.mode &&
          o.searchParams.set("mode", String(e.mode)),
        e.theme &&
          e.theme !== f.theme &&
          o.searchParams.set("theme", String(e.theme)),
        e.tools &&
          !e.lite &&
          (e.tools !== "closed" || e.activeTool !== "console") &&
          o.searchParams.set(
            e.tools === "none" ? "tools" : String(e.activeTool),
            String(e.tools)
          ),
        e.readonly !== void 0 &&
          o.searchParams.set("readonly", String(e.readonly)),
        e.editor && o.searchParams.set("editor", String(e.editor)),
        e.layout &&
          e.layout !== f.layout &&
          o.searchParams.set("layout", String(e.layout)),
        decodeURIComponent(o.href)
      );
    },
    ee = {
      cdn: (e) => {
...
`.trimStart();
      ...
      iframe: (e) => {
        let o = F(e),
          i = new URL(o);
        i.searchParams.delete("embed"), i.searchParams.delete("lite");
        let r = decodeURIComponent(i.href);
        return `
      ...
      html: (e) => {
        ...
        return (
          Object.keys(r).forEach((p) => {
            (JSON.stringify(r[p]) === JSON.stringify(f[p]) ||
              (p === "activeEditor" && r.activeEditor === "markup") ||
              ["markup", "style", "script"].includes(p)) &&
              delete r[p];
          }),
          Object.keys(r).length > 0 && (i.config = r),
          `
<div class="livecodes" style="height: 300px;" data-options='${L(
            JSON.stringify(i).replace(/'/g, "&#39;")
          )}'>
<pre data-lang="${t.markup.language}">${L(U(t.markup.content || ""))}</pre>
<pre data-lang="${t.style.language}">${L(U(t.style.content || ""))}</pre>
<pre data-lang="${t.script.language}">${L(U(t.script.content || ""))}</pre>
</div>
...
`.trimStart()
    ...
    c = { view: "split", tools: "closed", activeTool: "console", editor: "" },
    N = async () => {
      let e = Array.from(new FormData(T)).reduce(
        (n, [te, _]) => ({
          ...n,
          [te.replace("embed-", "")]: _ === "true" ? !0 : _,
        }),
        {}
      );
      (j = await m(!!e.permanentUrl)),
        (w = new URL(j)),
        (D = w.origin + w.pathname);
      let o = document.querySelectorAll('input[name="embed-view"]');
      e.mode !== "full"
        ? ((c.view = e.view || c.view),
          delete e.view,
          o.forEach((n) => {
            (n.checked = !1), (n.disabled = !0);
          }))
        : o.forEach((n) => {
            n.value === (e.view || c.view) && (n.checked = !0),
              (n.disabled = !1),
              n.checked && (e.view = n.value);
          });
      let i = document.querySelectorAll('input[name="embed-tools"]'),
        r = document.querySelectorAll('input[name="embed-activeTool"]'),
        d = document.querySelectorAll('input[name="embed-editor"]');
      e.lite
        ? ((c.tools = e.tools ?? c.tools),
          (c.editor = e.editor ?? c.editor),
          delete e.tools,
          delete e.editor,
          i.forEach((n) => {
            (n.checked = !1), (n.disabled = !0);
        ...
        : (i.forEach((n) => {
            n.value === (e.tools ?? c.tools) && (n.checked = !0),
              (n.disabled = !1),
              n.checked && (e.tools = n.value);
          }),
          d.forEach((n) => {
            n.value === (e.editor ?? c.editor) && (n.checked = !0),
              (n.disabled = !1),
              n.checked && (e.editor = n.value);
          })),
        e.lite || e.tools === "none"
          ? ((c.activeTool = e.activeTool || c.activeTool),
            delete e.activeTool,
            r.forEach((n) => {
              (n.checked = !1), (n.disabled = !0);
            }))
          : r.forEach((n) => {
              n.value === (e.activeTool || c.activeTool) && (n.checked = !0),
                (n.disabled = !1),
                n.checked && (e.activeTool = n.value);
            }),
        document
          .querySelectorAll('input[name="embed-activeEditor"]')
          .forEach((n) => {
            e.mode === "result"
              ? ((n.checked = n.value === y),
                (n.disabled = !0),
                delete e.activeEditor)
              : (n.disabled = !1);
          }),
        (R.src = F(e));
      let x = e.type,
        k = ee[x]?.(e),
        h = { npm: "javascript", react: "jsx" }[x] || "html";
      C.getLanguage() !== h ? C.setLanguage(h, k) : C.setValue(k);
    };
  u.addEventListener(T, "change", N),
    u.addEventListener(O, "click", async () => {
      B(C.getValue())
        ? a.success(
